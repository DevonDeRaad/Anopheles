...
runs<-data.frame(run1=r2vim$info$vim.run.1,run2=r2vim$info$vim.run.2)
write.csv(runs, "3R.temp.1.runs.csv", row.names = FALSE, quote = FALSE)
...
df<-data.frame(chrom=pos$chrom,
               snp=pos$bp,
               vim.run.1=r2vim$info$vim.run.1,
	       vim.run.2=r2vim$info$vim.run.2)
...
write.csv(df, "3R.temp.1.rel.vim.min.csv", row.names = FALSE, quote = FALSE)
