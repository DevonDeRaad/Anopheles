...
runs<-data.frame(run5=r2vim$info$vim.run.1,run6=r2vim$info$vim.run.2)
write.csv(runs, "3R.temp.3.runs.csv", row.names = FALSE, quote = FALSE)
...
df<-data.frame(chrom=pos$chrom,
               snp=pos$bp,
               vim.run.5=r2vim$info$vim.run.1,
               vim.run.6=r2vim$info$vim.run.2)
...
write.csv(df, "3R.temp.3.rel.vim.min.csv", row.names = FALSE, quote = FALSE)
