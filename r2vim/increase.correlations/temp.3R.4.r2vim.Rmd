...
runs<-data.frame(run7=r2vim$info$vim.run.1,run8=r2vim$info$vim.run.2)
write.csv(runs, "3R.temp.4.runs.csv", row.names = FALSE, quote = FALSE)
...
df<-data.frame(chrom=pos$chrom,
               snp=pos$bp,
               vim.run.7=r2vim$info$vim.run.1,
               vim.run.8=r2vim$info$vim.run.2)
...
write.csv(df, "3R.temp.4.rel.vim.min.csv", row.names = FALSE, quote = FALSE)
