...
runs<-data.frame(run3=r2vim$info$vim.run.1,run4=r2vim$info$vim.run.2)
write.csv(runs, "3R.temp.2.runs.csv", row.names = FALSE, quote = FALSE)
...
df<-data.frame(chrom=pos$chrom,
               snp=pos$bp,
               vim.run.3=r2vim$info$vim.run.1,
               vim.run.4=r2vim$info$vim.run.2)
...
write.csv(df, "3R.temp.2.rel.vim.min.csv", row.names = FALSE, quote = FALSE)
