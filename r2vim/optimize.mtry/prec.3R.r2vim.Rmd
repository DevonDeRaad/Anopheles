...
#create reg_data including pop, prec variable, and 3R chrom SNP matrix
...
write.csv(reg_data_corrected,file="3R.prec.corrected.csv", row.names = FALSE, quote=FALSE)
```
...
```{r}
##read in adjusted df
#reg_data_corrected<-read.csv("~/Downloads/3R.prec.corrected.csv")
#p<-ncol(reg_data_corrected)-2
#
