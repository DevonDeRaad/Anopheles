...
```{r}
detectCores()
#read in position information for 3R chrom
pos<-read.table("maf05.ld100.matrix.3R.012.pos")
...
write.csv(pos, file = "3R.chrom.no.missing.pos.csv", row.names = FALSE, quote=FALSE)
...
```{r}
##read in adjusted df
#reg_data_corrected<-read.csv("~/Downloads/3R.temp.corrected.csv")
#p<-ncol(reg_data_corrected)-2
#
