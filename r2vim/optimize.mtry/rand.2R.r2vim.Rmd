...
#create reg_data including pop, rand variable, and 2R chrom SNP matrix
reg_data<-as.data.frame(cbind(env.pop$population,env.pop$random,snp.matrix))
...
write.csv(reg_data_corrected,file="2R.rand.corrected.csv", row.names = FALSE, quote=FALSE)
```
...
```{r}
##read in adjusted df
#reg_data_corrected<-read.csv("~/Downloads/2R.rand.corrected.csv")
#p<-ncol(reg_data_corrected)-2
#
