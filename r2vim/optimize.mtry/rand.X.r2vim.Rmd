...
#create reg_data including pop, rand variable, and X chrom SNP matrix
...
write.csv(reg_data_corrected,file="X.rand.corrected.csv", row.names = FALSE, quote=FALSE)
```
...
```{r}
##read in adjusted df
#reg_data_corrected<-read.csv("~/Downloads/X.rand.corrected.csv")
#p<-ncol(reg_data_corrected)-2
#
