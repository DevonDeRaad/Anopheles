...
#read in 2R chrom SNP matrix, drop column 1, which is rowname
...
#create reg_data including pop, corr variable, and 2R chrom SNP matrix
...
write.csv(reg_data_corrected,file="2R.corr.corrected.csv", row.names = FALSE, quote=FALSE)
```
...
```{r}
##read in adjusted df
#reg_data_corrected<-read.csv("~/Downloads/2R.corr.corrected.csv")
#p<-ncol(reg_data_corrected)-2
#
