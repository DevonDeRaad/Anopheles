...
#pos<-read.table("ag1000g.phase1.ar3.pass.biallelic.maf05.X.geno.matrix.012.pos")
...
#snp.matrix<-read.table("ag1000g.phase1.ar3.pass.biallelic.maf05.X.geno.matrix.012")[,-1]
#
...
#write.csv(pos, "X.chrom.no.missing.pos", row.names = FALSE, quote = FALSE)
#
...
#write.csv(reg_data_corrected,file="X.precip.corrected.csv", row.names = FALSE, quote = FALSE)
```
...
```{r}
#read in adjusted df
reg_data_corrected<-read.csv("~/Downloads/X.precip.corrected.csv")
p<-ncol(reg_data_corrected)-2
