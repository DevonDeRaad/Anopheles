...
#pos<-read.table("ag1000g.phase1.ar3.pass.biallelic.maf05.2L.geno.matrix.012.pos")
...
#snp.matrix<-read.table("ag1000g.phase1.ar3.pass.biallelic.maf05.2L.geno.matrix.012")[,-1]
#
...
#write.csv(pos, "2L.chrom.no.missing.pos", row.names = F, quote = FALSE)
#
...
#write.csv(reg_data_corrected,file="2L.precip.corrected.csv", row.names = FALSE, quote = FALSE)
```
...
```{r}
#read in adjusted df
reg_data_corrected<-read.csv("~/Downloads/2L.precip.corrected.csv")
p<-ncol(reg_data_corrected)-2
