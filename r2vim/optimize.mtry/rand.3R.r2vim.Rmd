...
#create reg_data including pop, rand variable, and 3R chrom SNP matrix
...
write.csv(reg_data_corrected,file="3R.rand.corrected.csv", row.names = FALSE, quote=FALSE)
```
...
```{r}
##read in adjusted df
#reg_data_corrected<-read.csv("~/Downloads/3R.rand.corrected.csv")
#p<-ncol(reg_data_corrected)-2
#
