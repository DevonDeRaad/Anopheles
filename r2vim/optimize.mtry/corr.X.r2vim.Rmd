...
#create reg_data including pop, corr variable, and X chrom SNP matrix
...
write.csv(reg_data_corrected,file="X.corr.corrected.csv", row.names = FALSE, quote=FALSE)
```
...
```{r}
##read in adjusted df
#reg_data_corrected<-read.csv("~/Downloads/X.corr.corrected.csv")
#p<-ncol(reg_data_corrected)-2
#
