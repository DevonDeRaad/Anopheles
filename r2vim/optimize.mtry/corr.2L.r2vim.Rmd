...
#create reg_data including pop, corr variable, and 2L chrom SNP matrix
...
write.csv(reg_data_corrected,file="2L.corr.corrected.csv", row.names = FALSE, quote=FALSE)
```
...
```{r}
##read in adjusted df
#reg_data_corrected<-read.csv("~/Downloads/2L.corr.corrected.csv")
#p<-ncol(reg_data_corrected)-2
#
