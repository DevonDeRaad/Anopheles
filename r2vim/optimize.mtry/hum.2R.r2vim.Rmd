...
#
##create reg_data including pop, humidity variable, and X chrom SNP matrix
#reg_data<-as.data.frame(cbind(env.pop$population,env.pop$hannual,snp.matrix))
#
...
#write.csv(reg_data_corrected,file="2R.hum.corrected.csv", row.names = FALSE, quote=FALSE)
```
