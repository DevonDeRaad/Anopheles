...
lfmm.outlier.table <- read.csv("~/Downloads/ml.outputs/vetted.lfmm.temp.env.csv")
...
bayescan.outlier.table <- read.csv("~/Downloads/ml.outputs/vetted.bayescenv.temp.env.csv")[,2:3]
#add separate chrom and pos columns
...
r2vim.outlier.table <- read.csv("~/Downloads/ml.outputs/vetted.r2vim.temp.env.csv")[,2:3]
...
write.table(lfmm.gene.list, "/Users/devder/Desktop/anoph.phase2/overrep/lfmm.temp.gene.snp.match.txt", row.names = F, col.names = T, quote = F)
```
...
write.table(bayescan.gene.list, "/Users/devder/Desktop/anoph.phase2/overrep/bayescan.temp.gene.snp.match.txt", row.names = F, col.names = T, quote = F)
...
write.table(r2vim.gene.list, "/Users/devder/Desktop/anoph.phase2/overrep/r2vim.temp.gene.snp.match.txt", row.names = F, col.names = T, quote = F)
#look into how many genes overlap between the methods
length(intersect(unique(lfmm.gene.list$gene),unique(bayescan.gene.list$gene)))
```
...
write.table(result, file="/Users/devder/Desktop/anoph.phase2/overrep/lfmm.temp.go.overrep.txt",            row.names = F, col.names = F, quote = F)
```
...
write.table(result, file="/Users/devder/Desktop/anoph.phase2/overrep/bayescan.temp.go.overrep.txt", row.names = F, col.names = F, quote = F)
```
...
write.table(result, file="/Users/devder/Desktop/anoph.phase2/overrep/r2vim.temp.go.overrep.txt", row.names = F, col.names = F, quote = F)
```
