...
#calculate proportion of tested SNPs in each genomic region identified as significant for each GEA test (3 methods x 4 genomic regions x 5 environmental vairables = 60 data points)
```{r}
