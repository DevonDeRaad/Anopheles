#!/bin/sh
#
#SBATCH --job-name=bayescenv.anopheles.prec             # Job Name
...
/home/d669d153/work/bayescenv-new/source/bayescenv ${SLURM_ARRAY_TASK_ID}.geste.txt -env phase1.zprecip.txt -o ${SLURM_ARRAY_TASK_ID}.prec -threads 15
