#!/bin/sh
#
#SBATCH --job-name=bayescenv.anopheles.corr             # Job Name
...
/home/d669d153/work/bayescenv-new/source/bayescenv ${SLURM_ARRAY_TASK_ID}.geste.txt -env phase1.zcorr.txt -o ${SLURM_ARRAY_TASK_ID}.corr -threads 15
